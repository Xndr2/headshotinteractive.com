...
const UpdatesPage = () => {
  let updates = [
    { title: "We Have Our Own Website!", desc: "If you are reading this, welcome to the official Headshot Interactive website. We post everything on our Discord but more details here for those looking for an in depth explanation.", postLink: "/updates/We-Have-Our-Own-Website", date: "Today" },
